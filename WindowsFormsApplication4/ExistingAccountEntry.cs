...
{
    public partial class ExistingAccountEntry : Form
    {
        LogicClass lc = new LogicClass();
        public ExistingAccountEntry()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                //doo.CompareTo(dt) == dt.CompareTo(doo)
            ...
            if (flag1 == 0 && flag2 == 0 && flag3 == 0 && flag4 == 0 && flag5 == 0 && flag6 == 0 && flag7 == 0 && flag8 == 0)
            {
                ...
                if (textBox1.Text == arr[0].ToString())
                {
        ...
        private void ExistingAccountEntry_Load(object sender, EventArgs e)
        {
